...
# --- ensure_schema() early guard (prevents NameError on import) ---
try:
    ensure_schema
except NameError:
    import os, sqlite3
    ...
    def ensure_schema():
        ...
        ''')
        cur.execute("INSERT OR IGNORE INTO settings (key, value) VALUES ('header_title', 'WellAtlas 2.6 — Classic Map')")
        conn.commit(); conn.close()
    # Call once to guarantee schema exists before app init
    ensure_schema()
# --- end guard ---
